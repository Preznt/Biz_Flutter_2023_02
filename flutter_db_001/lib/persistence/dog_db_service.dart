...
class DogDbService {
  ...
  List<Dog> dogs = [
    const Dog(name: "퐁이", age: 7),
    const Dog(name: "럭키", age: 10),
    const Dog(name: "니키", age: 12),
    const Dog(name: "몽이", age: 3),
    const Dog(name: "꿈이", age: 1),
    const Dog(name: "귀여미", age: 17),
  ];

  /*
   * Future 클래스
   * 현재는 데이터가 없지만, 미래에 데이터가 필요할때 가져다 달라는 
   * 용도로 사용하는 클래스 
   */
